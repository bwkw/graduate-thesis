...
原子間の相互作用をほぼ無視できる低密度、流体相から固体層への相転移近傍の中密度、原子間の相互作用の寄与が大きい高密度において調べる。
...
\normalsize
では、原子間の相互作用をほぼ無視できる。
上記の式(\ref{eq:lowdensity-density})を満たすような低密度状態における分子の状態の概念図を以下の図\ref{}に示す。



上図の図\ref{}を満たすような低密度状態においては、原子間の相互作用をほとんど無視できるので、
