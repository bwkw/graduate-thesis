...
このLJポテンシャルの斥力作用と引力作用が入れ替わる$r=2^{\frac{1}{6}}$にカットオフを設けたポテンシャルをWeeks-Chandler-Andersen(以下WCA)ポテンシャルと呼ぶ。
...
上記のように、Heike Kamerlingh Onnesが提唱したビリアル展開は、圧力を密度の冪級数を用いて表現したものであるが、これを経験則的に拡張したものをBenedict–Webb–Rubin(以下BWR)式と呼ぶ。
BWR式は、ビリアル展開に$e^{-{\gamma}{\rho}^2}$を含めた項を付け加えたものであり、
